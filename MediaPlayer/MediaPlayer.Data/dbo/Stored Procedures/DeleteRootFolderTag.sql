CREATE PROCEDURE [dbo].[DeleteRootFolderTag]
(
...
BEGIN
	...
	IF NOT EXISTS (SELECT 1 FROM [RootFolderTag] WHERE [RootFolderPriority] = @RootFolderPriority AND [MediaItemType] = @MediaItemType AND [Tag] = @Tag)
	BEGIN
