...
namespace Utilities.Business
{
    public class VisualTreeHelpers
    {
        ...
        /// <summary>
        /// Traverses up the visual tree to find a parent of the specified type
        /// </summary>
        /// <typeparam name="T">Type of parent to look for</typeparam>
        /// <param name="from">Starting object</param>
        /// <returns>Parent with the specified type</returns>
