<%@ Page Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeBehind="CustomerAlbum.aspx.cs" Inherits="NisbetPhotography.Website.Private.Admin.CustomerAlbum" %>
<%@ MasterType VirtualPath="Admin.Master" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>

<asp:Content ID="conCustomerAlbumHead" ContentPlaceHolderID="cphAdminHead" runat="server">
...
<asp:Content ID="conCustomerAlbumBody" ContentPlaceHolderID="cphAdminBody" runat="server">
    
    <asp:Panel ID="pnlCustomerAlbum" runat="server" DefaultButton="btnSaveChanges">
        <div class="fields">
            <div class="field">
        ...
        <div class="options">
            <ul class="options">
                <li><input type="button" value="Cancel" class="option_button" onclick="window.location = 'Customer.aspx';" /></li>
                    ...
                    <ItemTemplate>
                        <div class="image">
                            <table class="image_wrapper" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="vertical-align: middle;"><img src="<%# DataBinder.Eval(Container.DataItem, "ImageUrl") %>" class="image_actual" /></td>
                                </tr>
                            </table>
                            <div class="image_thumbnail"><asp:RadioButton ID="rdoThumbnail" runat="server" Text="Thumbnail" GroupName="CustomerAlbum" Checked='<%# (Boolean)DataBinder.Eval(Container.DataItem, "Thumbnail") %>' customerImageId='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() %>' /></div>
